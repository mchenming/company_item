      ...
      <div class="site-content">
          ...
          <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" status-icon>
            ...
            <el-form-item>
              ...
              <div  style="text-align:center;color:#999999">没有账号？
                ...
                <a href="javascript:;" style="font-weight:bold" @click="registered()">注册</a>
        ...
        <el-dialog title="注册" :close-on-click-modal="false" :visible.sync="visible">
          <el-form :model="zcdataForm" :rules="zcdataRule" ref="zcdataForm" @keyup.enter.native="registeredSave()" label-width="80px">
            ...
            <el-form-item label="邮箱" prop="email" style="margin-bottom:13px;" class="mailSty">
              <el-input v-model="zcdataForm.email" placeholder="邮箱"></el-input>
              <p style="margin:0px;height:20px;line-height:20px;color:red;font-size:12px;">注意:邮箱务必与Redmine邮箱地址保持一致</p>
            </el-form-item>
  ...
  export default {
    data () {
      ...
      var zcvalidatePassword = (rule, value, callback) => {
        ...
        } else if (!this.zcdataForm.id && !/\S/.test(value)) {
          callback(new Error('密码不能为空'))
    ...
    methods: {
      ...
      dataFormSubmit () {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            var password = API.common.encode(this.dataForm.password)
            var row = {
