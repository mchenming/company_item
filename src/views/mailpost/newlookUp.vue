          ...
          <div style="background-color:#fff;width:70%;margin:auto;min-height:100vh;">
              ...
              <div class="m_content">
                  ...
                  <div style="display:flex;align-items:center;font-size:14px;margin:10px 0;">
                    ...
                    <div style="flex:1;">
                        <el-input type="textarea" v-model="sendInfo.messageDetail" autosize placeholder="【请结合“需求应用成效评价标准”总结需求上线后的应用效果，例如需求相关系统功能的使用情况等】" style="width:100%;" :disabled="isShow"></el-input>
                    </div>
                  </div>
                  ...
                  <div style="display:flex;align-items:center;font-size:14px;margin:10px 0;">
                    ...
                    <div style="flex:1;">
                        <el-input type="textarea" v-model="sendInfo.remainingProblems" autosize style="width:100%;" :disabled="isShow"></el-input>
                    </div>
                  </div>
          ...
          <div style="height:100vh;display:flex;flex-flow:column;">
              ...
              <div style="height:52%;padding:0 0 0 10px;background-color:#fff;overflow-y:auto;">
                <div style="padding:15px 10px;background-color:#fff;border:1px solid #ccc;height:100%;border-bottom:none;">
                    <p>变动历史</p>
                    <div v-if="Number($route.query.type)!==0 || $route.query.hasOwnProperty('addtype')">
